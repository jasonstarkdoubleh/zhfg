...
<!--      </div>-->
      ...
      <div style="padding: 24px;margin-top: 10px;background: #ffffff;border-radius: 4px">
        <div class="flex bgc">
          ...
          <div>
            价格类型:&nbsp;
            <el-select v-model="indexId" multiple collapse-tags style="width: 150px">
              <el-option
          ...
          <div>
            预警名称:&nbsp;
            <el-select v-model="warningName" multiple collapse-tags style="width: 150px">
              <el-option
