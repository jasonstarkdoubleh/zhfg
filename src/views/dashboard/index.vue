    ...
    <div class="main-body">
      <div class="left-section">
              ...
              <div style="text-align: center">
                ...
                <div style="margin-top: 15px;text-align: center">
                  <span v-for="(item, index) in numArrayAll" :key="index" class="num-style" style="color: #4eb1fd;border: 1px solid #4eb1fd;">
                    <vue-count-up :start-value="0" :end-value="item" />
                  </span>
                </div>
              </div>
        ...
        <div class="goods-details">
          ...
          <div v-loading="qiuLoading" class="goods-more">
            <div class="preview-title">
            ...
            <div class="goods-echarts">
              <div class="echarts-all">
                <div id="dashboardtwo" style="width: 100%;height: 100%" />
              </div>
            </div>
          </div>
          ...
          <div v-loading="qiuLoading" class="goods-more">
            ...
            <div class="goods-echarts">
              <div class="echarts-all">
                <div id="dashboardone" style="width: 100%;height: 100%" />
              </div>
            </div>
          </div>
      ...
      <div style="width: 55%;height: 100%;background: #fff;margin: 0 6px">
        ...
        <div class="goods-thing" style="height: calc(100% - 60px);">
          ...
          <div v-loading="qiuLoading" class="qiu" style="height:286px;text-align: center;margin-top: 100px;position: relative">
            ...
            <template v-for="(item, index) in goodsAll">
              <div :key="index" :style="itemStyle[index]" class="kuang">
                <div v-if="index < 4" class="kuang-sub">
                  ...
                  <div v-if="item.ewarnLevel === '绿色预警'" style="margin-top: 10px;color: green">
                    ...
                    <i v-if="item.priRange > 0" class="el-icon-caret-top" />
                ...
                <div v-if="index > 3" class="kuang-sub" style="text-align: left">
                  <div style="margin-top: 18px">{{ item.commName }}</div>
                  <div v-if="item.ewarnLevel === '绿色预警'" style="margin-top: 10px;color: green">
                    {{ item.priValue }}{{ item.unit }} {{ item.priRange }}%
                    <i v-if="item.priRange > 0" class="el-icon-caret-top" />
      ...
      <div class="right-section">
        <div class="goods-all">
          <div v-loading="loading" class="opinion-details">
            <div class="preview-title">
            ...
            <el-scrollbar style="height: calc(100% - 60px)">
              <div v-if="urlInfo.length > 0" class="opinion-body">
                ...
                <div v-for="(item, index) in infoCopy" :key="index" class="opinion-item">
                  <div class="opinion-index" style="width: 80%;">
          ...
          <div class="report-details">
            ...
            <el-scrollbar style="height: calc(100% - 60px)">
              <div class="opinion-body">
                ...
                <div v-if="rptList.length > 0" class="opinion-item">
                  <div class="opinion-index" style="cursor: pointer" @click="handleGolang(rptList[0].rptId)">
                    <div class="hot hot-red">
                      <span>1</span>
                    </div>&nbsp;&nbsp;
                    <div>
                ...
                <div v-if="rptList.length > 1" class="opinion-item">
                  <div class="opinion-index" style="cursor: pointer" @click="handleGolang(rptList[1].rptId)">
                    <div class="hot hot-orange">
                      <span>2</span>
                    </div>&nbsp;&nbsp;
                    <div>
                ...
                <div v-if="rptList.length > 2" class="opinion-item">
                  <div class="opinion-index" style="cursor: pointer" @click="handleGolang(rptList[2].rptId)">
                    <div class="hot hot-yellow">
                      <span>3</span>
                    </div>&nbsp;&nbsp;
                    <div>
                ...
                <div v-for="(item,index) in rptListCopy" :key="index" class="opinion-item">
                  <div class="opinion-index" style="cursor: pointer" @click="handleGolang(item.rptId)">
                    <div class="hot hot-gray">
                      <span>{{ index + 4 }}</span>
                    </div>&nbsp;&nbsp;
                    <div>
...
export default {
  ...
  methods: {
    ...
    drawOne(data) {
      const myChart = this.$echarts.init(document.getElementById('dashboardone'))
      const legendData = []
      const seriesData = []
      let num = 0
      for (const i in data) {
            ...
            itemStyle: {
              ...
              normal: {
                color: function(params) {
                  const colorList = ['green', '#ffcb48', 'orange', 'red']
    ...
    drawTwo(data) {
      const myChart = this.$echarts.init(document.getElementById('dashboardtwo'))
      let len = 0
      let k = ''
      ...
      const time = data[k].map((item, index) => {
        return data[k][index].ewarnDate
      })
      const keys = Object.keys(data)
      const dataValue1 = data[keys[0]].map(item => {
        return item.ewarnCount
      })
      const dataValue2 = data[keys[1]].map(item => {
        return item.ewarnCount
      })
      const dataValue3 = data[keys[2]].map(item => {
        return item.ewarnCount
      })
      const dataValue4 = data[keys[3]].map(item => {
        return item.ewarnCount
      })
      const option = {
        tooltip: {
